Here is the updated AdminDashboard.jsx with the write endpoints changed to /api/admin/frames.

Replace your file with this, commit, and redeploy:
...
export const AdminDashboard = () => {
  ...
  const fetchFrames = async () => {
    try {
      // GET usually stays at /api/frames so public users can see them too
...
Check the Network Tab after clicking "Add Frame". If you still get a 405 error, we must look at your backend/routes.py (or main backend file) to see exactly what route your FastAPI is actually expecting for POSTs!
...
<Button onClick={handleLogout} variant="outline" className="bg-white/10 hover:bg-white/20 text-white border-white/30" >
<LogOut className="w-4 h-4 mr-2" />
Logout
</Button>
</div>
